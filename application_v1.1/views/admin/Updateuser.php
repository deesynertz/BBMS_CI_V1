<section class="content">
	...
	<!-- <fieldset style="vertical-align:middle; width:98%;"><legend>Kuhusu nakala hii</legend></fieldset> -->
  <div class="row">
    <div class="col-md-12" style="margin-bottom: 10px">
      <div class="pull-right">
         <a href="<?php echo base_url('admins/user_list');?>"><button type="button" class="btn btn-primary">
  ...
  <div class="box">
    <div class="box-body">
  		<form class="" action="<?php echo base_url('admins/adduser');?>" method="POST">
				    	...
				    	<div class="col-sm-4">
					    	<label>Usess access Type </label>
					      	<select name="actyID" value="<?php echo set_value('district');?>" id="districtsel" size="1" class="form-control select2" style="width: 100%;">
					      		...
					      		<option value="<?php echo $row['actyID'];?>"><?php echo $row['adtyName'];?></option>
					      		<?php endforeach;?>
				            </select>
                        </div>
					</div>
