    ...
    <div class="box-body">
      <div class="box box-info">
        <div class="box-body pad">
          <form method="post" action="<?php echo base_url('addcontent');?>">
            ...
            <div class="form-group">
                <label>Tittle </span><small><i class="glyphicon glyphicon-asterisk text-red"></i></small></label>
                <input type="text" name="pacontTitle" class="form-control" placeholder="Page Title">
                <span class="text text-red"><?php echo form_error('pacontTitle');?>
            </div>
            <div class="form-group">
                <textarea id="editor" class="form-control" name="pacontDetails" rows="10" cols="80"></textarea>
                <span class="text text-red"><?php echo form_error('pacontDetails');?></span>
            </div>
            
            <div class="box-footer clearfix">
              <button type="Submit" class="pull-right btn btn-primary" name="sendcontent">Submit</button>
            </div>
          </form>
        </div>
      </div>
