    ...
    <script src="<?php echo base_url('assets/deesynertz/jssor.slider-27.1.0.min.js'); ?>" type="text/javascript"></script>
...
<div id="jssor_1" style="position:relative;top:0px;width:1200px;height:380px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
            ...
            <?php foreach ($fetch_galley->result() as $row) : ?> 
              <?php if($row->pacatID == 1) : ?>
                <?php if($row->pammision == 1) : ?>
                  <div data-p="170.00">
                    <img data-u="image" src="<?php echo base_url('assets/images/advatisiment_data/'.$row->pic); ?>"/>
                      <div data-u="thumb">
                        <img data-u="thumb" class="i" src="<?php echo base_url('assets/images/advatisiment_data/'.$row->pic); ?>" />
                        <span class="ti"><?php //echo $Translation['companyName']; ?></span><br />
